...
ActiveRecord::Schema[8.1].define(version: 2026_06_20_173132) do
  ...
  create_table "conversations", force: :cascade do |t|
    t.integer "conversation_type", null: false
    t.datetime "created_at", null: false
    t.string "name"
  ...
  create_table "user_settings", primary_key: "user_id", id: :bigint, default: nil, force: :cascade do |t|
    t.datetime "created_at", null: false
